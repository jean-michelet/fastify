...
const schema11 = {
  ...
  properties: {
    ...
    forceCloseConnections: { oneOf: [{ type: 'string', pattern: 'idle' }, { type: 'boolean' }] },
    ...
    requestIdHeader: { anyOf: [{ type: 'boolean' }, { type: 'string' }], default: false },
    ...
    constraints: {
      ...
      additionalProperties: {
        ...
        properties: { name: { type: 'string' }, storage: {}, validate: {}, deriveConstraint: {} },
      },
    },
  },
};
                            ...
                            if (valid0) {
                              ...
                              if (valid0) {
                                ...
                                if (valid0) {
                                  ...
                                  if (
                                    !(typeof data14 == 'number' && !(data14 % 1) && !isNaN(data14) && isFinite(data14))
                                  ) {
                                                          ...
                                                          for (const key2 in data23) {
                                                            ...
                                                            if (errors === _errs72) {
                                                              if (
                                                                ...
                                                                let missing1;
                                                                if (
                                                                  (data24.name === undefined && (missing1 = 'name')) ||
                                                                  (data24.storage === undefined &&
                                                                    (missing1 = 'storage')) ||
                                                                  (data24.validate === undefined &&
                                                                    (missing1 = 'validate')) ||
